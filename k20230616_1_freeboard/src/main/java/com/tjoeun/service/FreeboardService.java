...
public class FreeboardService {
	...
	//	increment.jsp 호출되는 조회수를 증가시킬 글번호를 넘겨받고 mapper를 얻어온 후, 메인글 조회수를 증가시키는
	...
	//	selectByIdx.jsp에서 호출되는 조회수를 증가시킨 글번호를 넘겨받고 mapper를 얻어온 후, 메인글의 메인글 1건을 얻어오는
	//	FreeboardDAO 클래스의 select sql 명령을 실행하는 메소드를 호출하는 메소드
	...
	//	deleteOK.jsp에서 호출되는 삭제할 글번호를 넘겨받고 mapper를 얻어온 후, 메인글의 메인글 1건을 얻어오는
	//	FreeboardDAO 클래스의 select sql 명령을 실행하는 메소드를 호출하는 메소드
	...
	//	updateOK.jsp에서 호출되는 수정할 정보가 저장된 객체를 넘겨받고 mapper를 얻어온 후, 메인글 1건을 얻어오는
	//	FreeboardDAO 클래스의 update sql 명령을 실행하는 메소드를 호출하는 메소드
	...
	//	list.jsp에서 호출되는 mapper를 얻어온 후, 모든 공지글을 얻어오는 
	//	FreeboardDAO 클래스의 select sql 명령을 실행하는 메소드를 호출하는 메소드
