...
//	singleton 클래스 디자인 패턴은 한 순간에 단 한개의 객체만 필요한 경우 사용하는 디자인 패턴이다.
//	singleton 패턴 코딩 방법
...
//	DAO 클래스에 글 1건을 테이블에 저장하는 insert sql 명령을 실행하는 메소드를 호출하는 메소드
	public void insert(GuestbookVO vo) {
		...
		//	ibatis mapper를 얻어온다.
		//	maepper에는 데이터베이스에 연결하는 connection과 연결된 후 실행할 sql 명령(guestbook.xml)이 저장되어 있다.
